        ...
        <button type="button" class="close close-cus" data-dismiss="modal" aria-label="Close">
			...
			<div class="right-sidebar-body customscroll">
				<div class="right-sidebar-body-content">
					...
					<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">Create Roles And Permission</h4>
								<p class="mb-30"></p>
							</div>
                                ...
                                <div class="row">
									<div class="col-md-3 col-sm-12">
										...
										<div class="custom-control custom-checkbox mb-5">
											...
											<label class="custom-control-label" for="customCheck1">Lead Create</label>
										</div>
										<div class="custom-control custom-checkbox mb-5">
					...
					<div class="page-header mb-0">
						<div class="row">
							<div class="col-md-2 col-sm-12">
								<div class="title">
									<h4> Users Roles<i class="icon-copy fa fa-star-o" aria-hidden="true"></i></h4>
								</div>
							</div>
							<div class="col-md-4 col-sm-12 ">
								<div class="dropdown d-flex">
									<a class="" href="#" role="button" href="javascript:;" data-toggle="right-sidebar">
								<button type="button" class="btn btn-primary">Create Role <i class="icon-copy fa fa-plus" aria-hidden="true"></i></button>
                                </a>	
								</div>
							</div>
							...
							<div class="pb-20">
								<table class="data-table table hover multiple-select-row nowrap">
									<thead>
										<tr>
											<th>Role Name</th>
											<th class="table-plus datatable-nosort">Permission</th>
											<th>Action</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											<td>Super Admin</td>
											<td class="table-plus">Lead Create,Lead Read,Lead Update,Lead Delete,User Create,User Read,User Update,User Delete,Test Create,Test Read,Test Update,Test Delete,Admission Create,Admission Read,Admission Update,Admission Delete	 </td>
											<td>
