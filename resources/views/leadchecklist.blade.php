  ...
  <!--end color switcher-->
        ...
        <button type="button" class="close close-cus" data-dismiss="modal" aria-label="Close">
			...
			<div class="right-sidebar-body customscroll">
				<div class="right-sidebar-body-content">
					...
					<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">Create Lead Checklist</h4>
								<p class="mb-30"></p>
							</div>
		...
		<div class="main-container">
			...
			<div class="card-box mb-30 page-header mb-0">
					<h2 class="h2text">LEAD CHECKLIST</h2>
					</div>
					...
					<div class="page-header mb-0">
						<div class="row">
							<div class="col-md-2 col-sm-12">
								<div class="title">
									<h4>Lead Checklist<i class="icon-copy fa fa-star-o" aria-hidden="true"></i></h4>
								</div>
							</div>
							<div class="col-md-4 col-sm-12 ">
								<div class="dropdown d-flex">
									<a class="" href="#" role="button" href="javascript:;" data-toggle="right-sidebar">
								<button type="button" class="btn btn-primary">Create Lead Checklist <i class="icon-copy fa fa-plus" aria-hidden="true"></i></button>
                                </a>	
								</div>
							</div>
