		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
						...
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark">676</div>
				...
				<div class="row pb-10">
					...
					<div class="col-md-4 mb-20">
						...
						<div class="card-box min-height-200px pd-20" data-bgcolor="#265ed7">
							...
							<div class="d-flex justify-content-between align-items-end">
								<div class="text-white">
									<div class="font-14">Admission</div>
					...
					<div class="col-lg-4 col-md-6 mb-20">
						<div class="card-box height-100-p pd-20 min-height-200px">
							<div class="d-flex justify-content-between pb-10">
								<div class="h5 mb-0">Top Counsollers</div>
								<div class="dropdown">
									<a
					...
					<div class="col-lg-4 col-md-6 mb-20">
						<div class="card-box height-100-p pd-20 min-height-200px">
							<div class="d-flex justify-content-between">
								<div class="h5 mb-0">Performance Report</div>
								<div class="dropdown">
									<a
										class="btn btn-link font-24 p-0 line-height-1 no-arrow dropdown-toggle"
										data-color="#1b3133"
					...
					<div class="col-lg-4 col-md-12 mb-20">
						<div class="card-box height-100-p pd-20 min-height-200px">
							...
							<div class="text-center">
								<div class="h5 mb-1">Acheivers</div>
								<div
				...
				<div class="card-box pb-10">
					<div class="h5 pd-20 mb-0">Recent Leads</div>
