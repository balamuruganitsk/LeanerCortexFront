			...
			<div class="right-sidebar-body customscroll">
				<div class="right-sidebar-body-content">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">Bulk Lead Upload
                                </h4>
								<p class="mb-30"></p>
							</div>
					...
					<div class="page-header mb-0">
						<div class="row">
							<div class="col-md-2 col-sm-12">
								<div class="title">
									<h4>Bulk Lead <i class="icon-copy fa fa-star-o" aria-hidden="true"></i></h4>
								</div>
							</div>
							<div class="col-md-4 col-sm-12 ">
								...
								<button type="button" class="btn btn-primary"> Upload Lead <i class="icon-copy fa fa-plus" aria-hidden="true"></i></button>
                                </a>
